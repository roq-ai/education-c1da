  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Education - Your Ultimate Platform for Streamlined Homework and Assignment Management. Empowering Students for Success."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Education - Your Ultimate Platform for Streamlined Homework and Assignment Management. Empowering Students for Success.`}
            </Text>
            <Box
